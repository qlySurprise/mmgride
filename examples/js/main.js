$(document).ready(function(){
    ...
    //列
    var cols = [
        {title:'d行情', name:'', width: 30, align: 'center', renderer: function(val,item,rowIndex){
            return '<div class="btnPrice"></div>';
        }},
        { title:'d股票s代码', name:'SECUCODE' ,width:100, align:'center' },
        { title:'股票ss名称', name:'SECUABBR' ,width:100, align:'center'},
        { title:'今收盘', name:'CLOSINGPRICE' ,width:60, align:'right', renderer: fixed2},
        { title:'涨跌s幅', name:'DAYCHANGERATE' ,width:60, align:'right',renderer: highliht},
